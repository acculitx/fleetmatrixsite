...
SELECT 
  ...
  round(avg(totalScore),2) as total,
  round(avg(aggressiveScore),2) as aggressivity,
  round(avg(distractionScore),2) as distraction
FROM fleet_daily_total_score as score
