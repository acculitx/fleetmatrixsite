...
<form action="<?php echo JRoute::_($this->getRoute()); ?>" id="adminForm" method="post" name="adminForm">
	<table id="vigilance_table" class="adminlist sortable">
		<thead><?php echo $this->loadTemplate('vigilancetrend_head');?></thead>
		<tfoot><?php echo $this->loadTemplate('vigilancetrend_foot');?></tfoot>
		<tbody><?php echo $this->loadTemplate('vigilancetrend_body');?></tbody>
	</table>
</form>
</div>
<br />
