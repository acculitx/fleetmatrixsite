...
foreach ( $this->items as $i => $item ) {
	...
	$count = 2; // indicate non-first iteration
	
	$values [] = $a;
	$names [] = $item->vehicle_name;
}
// echo "values: "; echo "<pre>"; print_r($values);
// echo "names: "; echo "<pre>"; print_r($names);
// echo "xlabels: "; echo "<pre>"; print_r($xlabels);
...
if (count ( $values ) > 0) {
	$chart123 = renderLineChartForMpg ( $values, $names, "Trends over time", $xlabels );
	
// 	echo "<pre>"; echo "data: "; print_r($chart123);
