<?php
    ...
    class Axis {
        ...
        public function quantizeTics() {
            ...
            if (array_key_exists('graph_tics', $GLOBALS)) {
               $tics = $GLOBALS['graph_tics'];
            }
        ...
        public function computeBoundaries() {
            ...
            if (array_key_exists('graph_max', $GLOBALS)) {
               $this->displayMax = $GLOBALS['graph_max'];
            }
            if (array_key_exists('graph_min', $GLOBALS)) {
               $this->displayMin = $GLOBALS['graph_min'];
            }
