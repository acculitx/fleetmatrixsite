...
else {$bgmodulemedia="mod_blank17v15";}

//Select surrounds source folder

$surmodulemedia='mod_blank17v15';
...
if ($surroundstyle=="custom"){$surroundpx=$custompx;$surmodulemedia="mod_blank17v15";}

//colours & backgrounds

$bgpattern = $params->get('bgpattern');

if($bgpattern == "custom"){$bgmodulemedia="mod_blank17v15";}
