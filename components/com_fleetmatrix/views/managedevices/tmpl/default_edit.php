    ...
    <form class="form-validate" action="<?php echo JRoute::_('index.php'); ?>" method="post" id="managedevices" name="managedevices">
		<fieldset>
        	<dl>
                ...
                <dt></dt><dd></dd>
                    <dt><?php echo $this->form->getLabel('selectsubscription'); ?></dt>
        	    <dd><?php echo $this->form->getInput('selectsubscription'); ?></dd>
                <dt></dt>
                ...
                <button type="submit" name="submit" class="button" style="margin-right: 5px" value="Exchange"><?php echo JText::_('Add to Existing'); ?></button>
    ...
    jQuery(document).ready(function($) {
        ...
        $('#jform_selectcompany').change(function() {
            ...
            jQuery.getJSON(url, function(data) {
                ...
                url = "<?php echo JRoute::_($this->getRoute().'&layout=json&format=raw&task=subscription&cmd='); ?>"+val;
                jQuery.getJSON(url, function(data) {
                    $('#jform_selectsubscription').html(data);
            });
            });
        });
    });
