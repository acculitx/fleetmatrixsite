<?php
    ...
    class Plot {
        ...
        public function Plot($width, $height) {
            ...
            $this->graphCaptionRatio = array(0.80, 0.13);
        ...
        private function computeGraphArea() {
            ...
            $graphArea = null;
            if ($this->hasCaption) {
                $graphUnpaddedRight = $this->imageArea->x1 + ($this->imageArea->x2 - $this->imageArea->x1) * $this->graphCaptionRatio[0]
        ...
        private function computeCaptionArea() {
            $graphUnpaddedRight = $this->imageArea->x2 - ($this->imageArea->x1 + ($this->imageArea->x2 - $this->imageArea->x1) * $this->graphCaptionRatio[1]);
                    + $this->graphPadding->left + $this->graphPadding->right;
            $titleUnpaddedBottom = $this->imageArea->y1 + $this->titleHeight + $this->titlePadding->top + $this->titlePadding->bottom;
        ...
        public function createImage() {
            ...
            $this->backGroundColor = new Color(0xF7, 0xF7, 0xF7);
