...
<?php endif;?>
<?php if (!$logo ): ?>
	<h1 id="logo"><a href="index.php" title="<?php echo $app->getCfg('sitename'); ?>"><?php echo htmlspecialchars($templateparams->get('sitetitle'));?> <span><?php echo htmlspecialchars($templateparams->get('sitedescription'));?></span></a></h1>
<?php endif;?>
